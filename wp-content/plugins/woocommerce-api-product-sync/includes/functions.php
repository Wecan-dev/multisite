                                ...
                                foreach ( $available_variations as $available_variation ) {
                                    ...
                                    if ( $price_adjustment ) {
                                        ...
                                        if ( isset( $variation_product_info_data['regular_price'] ) && $variation_product_info_data['regular_price'] ) {
                                            ...
                                            if ( $destination_data['sale_price'] ) {
                                                $destination_data['price'] = "".$destination_data['sale_price']."";
                                            } else {
                                                $destination_data['price'] = "".$destination_data['regular_price']."";
                                            }
...
if ( ! function_exists( 'wc_api_mps_wp_trash_post' ) ) {
    add_action( 'wp_trash_post', 'wc_api_mps_wp_trash_post' );
...
if ( ! function_exists( 'wc_api_mps_before_delete_post' ) ) {
    add_action( 'before_delete_post', 'wc_api_mps_before_delete_post' );
