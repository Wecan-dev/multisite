...
n();else{var c=a('<div class="modal fade" id="lfb_winPass" tabindex="-1" role="dialog" aria-hidden="true"></div>');c.append('<div class="modal-dialog"><div class="modal-content"><div class="modal-header"></div><div class="modal-body"></div></div></div>');c.find(".modal-header").append('<h4 class="modal-title"><i class="fas fa-lock-open"></i>'+lfb_dataCust.txtCustomersDataForgotPassLink+'</h4><a href="javascript:" class="close" data-dismiss="modal" aria-label="Close"><span class="fas fa-times"></span></a>');
c.find(".modal-body").append('<div class="form-group"><div class="input-group"><div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div><input type="text" class="form-control" id="lfb_manEmailPass" placeholder="'+lfb_dataCust.customersDataLabelEmail+'"></div></div>');c.find(".modal-body").append('<a href="javascript:" data-action="sendPass"  class="btn btn-primary"><span class="glyphicon glyphicon-envelope"></span>'+lfb_dataCust.customersAc_sendPass+"</a>");c.find(".modal-body").append('<p id="lfb_passLostConfirmation"  style="text-align: center;"><span class="fas fa-check"></span><br/>'+
lfb_dataCust.txtCustomersDataForgotPassSent+"</p>");a("#estimation_popup").append(c);a("#lfb_winPass").find("#lfb_passLostConfirmation").hide();c.find('a[data-action="sendPass"]').click(v)}})})(jQuery);