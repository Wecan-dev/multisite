(function ($) {
    ...
    function initLoginUI() {
        ...
        winPass.find('.modal-body').append('<a href="javascript:" data-action="sendPass"  class="btn btn-primary"><span class="glyphicon glyphicon-envelope"></span>' + lfb_dataCust.customersAc_sendPass + '</a>');
