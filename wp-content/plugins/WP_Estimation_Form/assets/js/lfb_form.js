...
function wpe_initForms() {
    jQuery.each(wpe_forms, function () {
        ...
        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_btnPayStripe').click(function () {
            ...
            $panel.find('.itemBloc:not(.lfb_disabled)').each(function () {
                ...
                if ($itembloc.find('div[data-type="slider"]').length > 0) {
                    ...
                    if (jQuery(itemSelf).data('price')) {
                        ...
                        if (showSummary) {
                            content += '    - ' + quantityText + title + ' : ' + priceItem + '<br/>';
                            contentGform += ' - ' + quantityText + title + ' : ' + priceItem + '\n';
                        }
                    } else {
                        var title = jQuery(itemSelf).attr('data-originaltitle');
                        if (jQuery(itemSelf).is('select')) {
...
function wpe_changeStep(stepID, formID) {
    ...
    if (stepID == 'final') {
        ...
        if (activatePaypal) {
            ...
            if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns').length > 0) {
                if (lfb_lastSteps.length > 0) {
                   /* if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns .lfb_linkPreviousCt').length > 0) {
                        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns .lfb_linkPreviousCt').show();
                    } else {*/
                      //  jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #finalSlide .lfb_linkPreviousCt').show();
                  //  }
                } else {
                 //   jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #finalSlide .lfb_linkPreviousCt').hide();
                }
    ...
    var heightP = jQuery(' #estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + stepID + '"]').outerHeight() + 100 + titleHeight;
    ...
    setTimeout(function () {
    setTimeout(function () {
        heightP = jQuery(' #estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + stepID + '"]').outerHeight() + 100 + titleHeight;
            ...
            if (activatePaypal) {
                if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns').length == 0) {
                    if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_razorPayCt').length > 0) {
                        ...
                        /*if (lfb_lastSteps.length > 0) {
                            jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #mainPanel #lfb_razorPayCt .lfb_linkPreviousCt').fadeIn();
                        }*/


                    } else if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] .lfb_btnNextContainerStripe').length > 0) {

                      /*  if (lfb_lastSteps.length > 0) {
                            jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + stepID + '"] .lfb_btnNextContainerStripe .linkPrevious').delay(form.animationsSpeed * 3).fadeIn(500);
                        }*/
        ...
        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] [data-tooltiptext][data-tooltipimg!=""]').each(function () {
...
function wpe_toggleField(fieldID, formID) {
    ...
    setTimeout(function () {
        ...
        var heightP = jQuery(' #estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid=' + form.step + ']').outerHeight() + 100 + titleHeight;
        jQuery(' #estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel').css('min-height', heightP);
    }, 300);
}
...
function lfb_checkUserEmail_bak(form) {
    var rep = true;
    var formID = form.formID;
    if (form.useEmailVerification == 1 && (typeof (form.verifiedEmail) == 'undefined' || !form.verifiedEmail) && jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] [data-fieldtype="email"][data-required="true"]').length > 0) {
        rep = false;
        var emailField = jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] [data-fieldtype="email"][data-required="true"]').last();
        if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationContainer').length == 0) {
            emailField.closest('.genSlide').find('#lfb_lastStepDown').before('<div id="lfb_emailActivationContainer"><div class="alert alert-secondary">' + form.txt_emailActivationInfo + '</div><div class="form-group"><label>' + form.txt_emailActivationCode + ': </label><input type="text" id="lfb_emailActivationField" class="form-control"/></div></div>');
        }
        ...
        if (typeof (form.emailProposed) == 'undefined' || form.emailProposed != emailField.val()) {
            ...
            jQuery.ajax({
                ...
                success: function () {
                    jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationContainer').addClass('lfb_open');

                    if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]').is('.wpe_fullscreen')) {
                        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]').animate({
                            scrollTop: jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationField').position().top - (80 + parseInt(form.scrollTopMargin))
                        }, form.animationsSpeed * 2);
                    } else {
                        jQuery('body,html').animate({
                            scrollTop: jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationField').position().top - (80 + parseInt(form.scrollTopMargin))
            ...
            jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationField').closest('.form-group').removeClass('has-error');

            var code = jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationField').val();
            if (code.length == 4) {
                jQuery.ajax({
                    url: form.ajaxurl,
                    type: 'post',
                    data: {
                        action: 'lfb_verificationCode',
                        formID: formID,
                        code: code
                    },
                    success: function (rep) {
                        if (rep == 1) {
                            ...
                            jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationContainer').removeClass('lfb_open').slideUp();
                            ...
                            jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationField').closest('.form-group').addClass('has-error');
                            if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]').is('.wpe_fullscreen')) {
                                jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]').animate({
                                    scrollTop: jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_emailActivationField').position().top - (80 + parseInt(form.scrollTopMargin))
                                }, form.animationsSpeed * 2);
...
function lfb_checkUserEmail(form) {
    var rep = true;
    var formID = form.formID;
    if (form.enableCustomerAccount == 1 && (typeof (form.verifiedEmail) == 'undefined' || !form.verifiedEmail) && jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] [data-fieldtype="email"][data-required="true"]').length > 0) {
        rep = false;
                ...
                jQuery.ajax({
                    ...
                    success: function (rep) {
                        if (rep.trim() == 1) {
                            ...
                            if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]').is('.wpe_fullscreen')) {
                                jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]').animate({
                                    scrollTop: jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_forgotPassCt').position().top - (80 + parseInt(form.scrollTopMargin))
                                }, form.animationsSpeed * 2);
                            } else {
                                jQuery('body,html').animate({
                                    scrollTop: jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + form.step + '"] #lfb_forgotPassCt').position().top - (80 + parseInt(form.scrollTopMargin))
