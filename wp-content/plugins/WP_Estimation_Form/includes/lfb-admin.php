    ...
    public function view_edit_lfb() {
        if (current_user_can('manage_options')) {
            ...
            echo '<div id="lfb_formTopbtns">
                ...
                <a href="javascript:" data-action="previewForm" id="lfb_btnPreview" target="_blank"  class="btn btn-default"><span class="glyphicon glyphicon-eye-open"></span>' . __("View the form", 'lfb') . '</a>
...
<h4> ' . __('Stripe payment', 'lfb') . ' </h4>             
           ...
           <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" style="margin-left: 8px;" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-search"></span></a>
            ...
            <a href="https://www.google.com/recaptcha/admin/create" target="_blank" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-info-sign"></span></a>
                                ...
                                <!--<div class="form-group" >
                                    <label > ' . __('Use email verification', 'lfb') . ' </label >
                                    <input  type="checkbox"  name="useEmailVerification" data-switch="switch" data-on-label="' . __('Yes', 'lfb') . '" data-off-label="' . __('No', 'lfb') . '"/>
                                </div>-->
	...
	[quantity] = ([item-3_price]/2)*[item-1_quantity]
            ...
            echo '<div class="form-group" >
                    <div class="lfb_calculationToolbar">
                        ...
                        <a href="javascript:" id="lfb_addDistanceBtn" onclick="lfb_calculationModeQt=2;lfb_editDistanceValue(2);" class="btn btn-default" ><span class="glyphicon glyphicon-plus"></span>' . __('Add a distance', 'lfb') . '</a>
        ...
        if (current_user_can('manage_options')) {
            ...
            if (count($forms) > 0) {
                ...
                foreach ($logs as $log) {
                    ...
                    /* $formTitle = "";
                      $rep .= '<tr data-id="' . $log->id . '" data-formid="' . $log->formID . '" data-logid="' . $log->id . '" data-useremail="' . $this->parent->stringDecode($log->email, $settings->encryptDB) . '">
                      <td><input name="tableSelector" type="checkbox" /></td>
                      <td>' . date(get_option('date_format'), strtotime($log->dateLog)) . '</td>
                      <td><a href="javascript:" data-action="viewOrder" onclick="lfb_loadLog(' . $log->id . ');">' . $log->ref . '</a></td>
                      ...
                      <td class="lfb_logStatusTd">' . $statusText . '</td>
                      <td>
                      <a href="javascript:" data-action="viewOrder" class="btn btn-primary btn-circle" data-toggle="tooltip" title="' . __('View this order', 'lfb') . '" data-placement="bottom"><span class="glyphicon glyphicon-search"></span></a>
                      <a href="javascript:"  data-action="editOrder"  class="btn btn-default btn-circle" data-toggle="tooltip" title="' . __('Edit', 'lfb') . '" data-placement="bottom"><span class="glyphicon glyphicon-pencil"></span></a>
                      <a href="javascript:"  data-action="downloadOrder"  class="btn btn-default btn-circle" data-toggle="tooltip" title="' . __('Download the order', 'lfb') . '" data-placement="bottom"><span class="fa fa-file-download"></span></a>
                      <a href="javascript:"  data-action="editCustomer" data-customerid="' . $log->customerID . '" class="btn btn-default btn-circle" data-toggle="tooltip" title="' . __('Customer information', 'lfb') . '" data-placement="bottom"><span class="fas fa-user"></span></a>
                      <a href="javascript:" data-action="deleteOrder" class="btn btn-danger btn-circle" data-toggle="tooltip" title="' . __('Delete this order', 'lfb') . '" data-placement="bottom"><span class="glyphicon glyphicon-trash"></span></a></td>
                      </tr>'; */
                }
            }
            //  echo $rep;
                    ...
                    if ($res === TRUE) {
                        ...
                        if (array_key_exists('forms', $dataJson)) {
                            foreach ($dataJson['forms'] as $key => $value) {
                                ...
                                if ($value['emailVerificationContent'] == null) {
    ...
    public function getCustomersList() {
        ...
        if (current_user_can('manage_options')) {
            ...
            foreach ($customers as $customer) {
                ...
                $customer->company = $this->parent->stringDecode($customer->company, $settings->company);
